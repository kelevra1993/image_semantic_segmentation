...
class AnnotationsConverter():
    def __init__(self, image_path: str, annotation_path: str, label_dictionary: Dict,
                 method: Literal["naive", "ambiguous"]) -> None:
    ...
    def show_mask(self):
        cv2.imshow("Image Mask", self.neural_network_mask)
        cv2.waitKey(0)
...
base = "/Users/Robert/PycharmProjects/bacteria_biology/technical_information/dataset"
bacteria_path = os.path.join(base, "bacteria.png")
annotation_path = os.path.join(base, "annotations.json")

label_dictionary = {"membrane": 0, "bacteria": 100, "unsure": 200}

annotations = AnnotationsConverter(image_path=bacteria_path,
                                   annotation_path=annotation_path,
                                   label_dictionary=label_dictionary,
                                   method="ambiguous")
annotations.show_mask()
